        ...
        <div>
            ...
            >
                ...
                <DialogActions className="d-flex d-flex justify-content-between">
                    <Button onClick={() => { window.location.reload() }} name="cancelBtn" variant="contained" >Cancel</Button>
                    <Button type="submit" name="editBtn" variant="contained" data-testid="editBtn" color="success">Update</Button>
                </DialogActions>
            </Dialog>
