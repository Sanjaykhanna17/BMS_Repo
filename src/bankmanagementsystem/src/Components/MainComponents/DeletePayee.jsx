        ...
        <div>
            ...
            >
                ...
                <DialogActions className="d-flex d-flex justify-content-between">
                    <Button onClick={() => { window.location.reload() }} data-testid="cancelBtn" name="cancelBtn" variant="contained" >Cancel</Button>
                    <Button onClick={(e) => { handleDelete(e) }} data-testid="confirmBtn" name="confirmBtn" variant="contained" color="success">Confirm</Button>
                </DialogActions>
            </Dialog>
